...
#vio
    ...
    def plot_hist(self, x=None, title='', x_label='', y_label='', bins=10):
        ...
        try:
            import astetik as ast
            return ast.hist(self.data, x=x, title=title, x_label=x_label, y_label=y_label, bins=bins)
        except RuntimeError:
            print('Matplotlib Runtime Error. Plots will not work.')
...
#vio
    def plot_regs(self, x=None, y=None, title='', x_label='', y_label=''):
        ...
        try:
            import astetik as ast
            return ast.regs(self.data, x=x, y=y, title=title, x_label=x_label, y_label=y_label)
        except RuntimeError:
            print('Matplotlib Runtime Error. Plots will not work.')
